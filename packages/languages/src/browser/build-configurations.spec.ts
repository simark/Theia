...
describe("build-configurations", function() {
    it("should work with no .theia/builds.json", async function() {
    ...
    it("should work with an empty .theia/builds.json", async function() {
    ...
    it("should work with a {} .theia/builds.json", async function() {
        const service = await initializeTest('{}', undefined);
    ...
    it("should ignore invalid json in .theia/builds.json", async function() {
