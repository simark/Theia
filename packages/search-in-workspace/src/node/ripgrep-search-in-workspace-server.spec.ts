...
import {
        ...
        searchInWorkspaceResultCompare
...
class ResultAccumulator implements SearchInWorkspaceClient {
        ...
        onDone(searchId: number): void {
                ...
                this.results.sort(searchInWorkspaceResultCompare);
                this.onDoneCallback();
        }
}
...
function compareSearchResults(expected: SearchInWorkspaceResult[], actual: SearchInWorkspaceResult[]) {
        ...
        for (let i = 0; i < actual.length; i++) {
                ...
                const relativeFilename = e.file.slice((rootDir + '/').length);
                const lines = fileLines.get(relativeFilename);
                if (lines) {
...
describe('ripgrep-search-in-workspace-server', () => {
        ...
        it('returns 7 results when searching for "carrot"', function (done) {
                ...
                const client = new ResultAccumulator(() => {
                        const expected: SearchInWorkspaceResult[] = [
                                { file: rootDir + '/carrots', line: 1, character: 11, length: pattern.length, lineText: '' },
                                { file: rootDir + '/carrots', line: 2, character: 6, length: pattern.length, lineText: '' },
                                { file: rootDir + '/carrots', line: 2, character: 35, length: pattern.length, lineText: '' },
                                { file: rootDir + '/carrots', line: 3, character: 28, length: pattern.length, lineText: '' },
                                { file: rootDir + '/carrots', line: 3, character: 52, length: pattern.length, lineText: '' },
                                { file: rootDir + '/carrots', line: 4, character: 1, length: pattern.length, lineText: '' },
                                { file: rootDir + '/potatoes', line: 1, character: 18, length: pattern.length, lineText: '' },
                        ];
        ...
        it('returns 1 result when searching for "Carrot"', function (done) {
                const client = new ResultAccumulator(() => {
                        const expected: SearchInWorkspaceResult[] = [
                                { file: rootDir + '/carrots', line: 4, character: 1, length: 6, lineText: '' },
                        ];
        ...
        it('works with a lot of results', function (done) {
                ...
                const client = new ResultAccumulator(() => {
                        const expected: SearchInWorkspaceResult[] = [];
                        const file = rootDir + '/lots-of-matches';
        ...
        it('searches for regexes', function (done) {
                ...
                const client = new ResultAccumulator(() => {
                        const expected: SearchInWorkspaceResult[] = [
                                { file: rootDir + '/regexes', line: 1, character: 5, length: 5, lineText: '' },
                                { file: rootDir + '/regexes', line: 1, character: 13, length: 4, lineText: '' },
                                { file: rootDir + '/regexes', line: 1, character: 20, length: 5, lineText: '' },
                                { file: rootDir + '/regexes', line: 1, character: 25, length: 6, lineText: '' },
                                { file: rootDir + '/regexes', line: 2, character: 1, length: 5, lineText: '' },
                        ];
        ...
        // Try with a pattern starting with -.
        it('searches a pattern starting with -', function (done) {
                const pattern = '-fo+bar';

                const client = new ResultAccumulator(() => {
                        const expected: SearchInWorkspaceResult[] = [
                                { file: rootDir + '/file:with:some:colons', line: 1, character: 28, length: 7, lineText: '' },
                        ];
        ...
        it('searches a pattern starting with --', function (done) {
                ...
                const client = new ResultAccumulator(() => {
                        const expected: SearchInWorkspaceResult[] = [
                                { file: rootDir + '/file:with:some:colons', line: 1, character: 27, length: 8, lineText: '' },
                        ];
        ...
        it('searches in a UTF-8 file', function (done) {
                ...
                const client = new ResultAccumulator(() => {
                        const expected: SearchInWorkspaceResult[] = [
                                { file: rootDir + '/utf8-file', line: 1, character: 7, length: 4, lineText: '' },
                                { file: rootDir + '/utf8-file', line: 1, character: 23, length: 4, lineText: '' },
                        ];
        ...
        it('searches a UTF-8 pattern', function (done) {
                ...
                const client = new ResultAccumulator(() => {
                        const expected: SearchInWorkspaceResult[] = [
                                { file: rootDir + '/utf8-file', line: 1, character: 4, length: 3, lineText: '' },
                                { file: rootDir + '/utf8-file', line: 1, character: 20, length: 3, lineText: '' },
                                { file: rootDir + '/utf8-file', line: 1, character: 27, length: 4, lineText: '' },
                        ];
